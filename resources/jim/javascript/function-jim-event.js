          ...
          case itemType.checkboxlist:
            ...
            for(i = 0; i < values.length; i += 1) {
              ...
              if(jimDevice.isMobile() && jimDevice.isiOS()) {
            	  html += "<td><div class=\""+type+" unchecked\" "+property+" "+readonly+" /><span class=\"option\">"+option+"</span></td>";
              }
              else {
                html += "<td><div class=\""+type+" unchecked\" "+property+" "+readonly+" tabindex=\"-1\"><div class=\"backgroundLayer\"><div class=\"colorLayer\" /><div class=\"imageLayer\" /></div></div><span class=\"option\">"+option+"</span></td>";
              }
              if(!isHorizontal) { html += "</tr>"; }
            }
            if(isHorizontal) { html += "</tr>"; }
